...
import gradio as gr
from modules import call_queue, script_callbacks, scripts, shared, ui_components
...
from agent_scheduler.db import TaskStatus, task_manager
from agent_scheduler.db import init as init_db
...
class Script(scripts.Script):
    ...
    def bind_enqueue_button(self, root: gr.Blocks):
        ...
        dependencies: list[dict] = [
            x
            for x in get_dependencies(root)
        ...
        with root:
            ...
            click_event = self.submit_button.click(**args)  # ty:ignore[invalid-argument-type]
            root._tracked_events = getattr(root, "_tracked_events", []).append(  # ty:ignore[unresolved-attribute]
                click_event
            )
            ...
            if cnet_dependency is not None:
                ...
                click_event = self.submit_button.click(
                    fn=ui_control_net_unit,
